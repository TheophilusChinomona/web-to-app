...
- Name: e2e.spec.ts >> WebToApp Builder E2E >> dark mode toggle works
- Location: playwright-tests/e2e.spec.ts:109:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:19006/
Call log:
  - navigating to "http://localhost:19006/", waiting until "load"
