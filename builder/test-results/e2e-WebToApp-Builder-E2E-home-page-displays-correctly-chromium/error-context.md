...
- Name: e2e.spec.ts >> WebToApp Builder E2E >> home page displays correctly
- Location: playwright-tests/e2e.spec.ts:18:7
...
Locator: locator('text=WebToApp Builder')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=WebToApp Builder')
